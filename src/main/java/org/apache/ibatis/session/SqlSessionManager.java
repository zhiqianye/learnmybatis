...
public class SqlSessionManager implements SqlSessionFactory, SqlSession {
    ...
    //以下6个方法对应SqlSessionFactoryBuilder的多种不同构建方法
    ...
    //以下8个方法是业务是打开一个SqlSession，并加入到本地存储中。8种是因为有8中openSession方式
    ...
    //检查本地存储中是否有SqlSession
    public boolean isManagedSessionStarted() {
        return this.localSqlSession.get() != null;
    }

    //以下9个覆盖方法全部为sqlSessionFactory的代理
    @Override
    ...
    //下面几个需要SqlSession的方法，先从本地存储中取，如果没有，则抛异常；如果有，再代理
    @Override
