...
public class ResolverUtil<T> {
     ...
     */
    /**
     * 用于校验一个类是否是已知类的子类。注意，match方法会匹配到已知类自身
     */
     ...
     */
    /**
     * 返回用于查找类的classloader。如果classloader属性为空，则返回ContextClassLoader
     */
     ...
     */
    /**
     * 在路径packageNames上查找parent类的实现类
     * @param parent 已知父类
     * @param packageNames java包名
     * @return 工具对象本身
     */
     ...
     */
    /**
     * 在路径packageNames上查找被annotation标注过的类
     * @param annotation 注解Class实例
     * @param packageNames java包名
     * @return 工具对象本身
     */
